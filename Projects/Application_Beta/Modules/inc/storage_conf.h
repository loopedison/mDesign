...
/* Exported define -----------------------------------------------------------*/
#define STORAGE_VERSION         (0xff010200)
...
typedef struct
{
  ...
  uint8_t                 xPeriod[2];
  uint8_t                 xCalcMode[1];
  uint8_t                 xReserved[12];
}Storage_MsgDataUserConfTypeDef;
typedef struct
{
  uint8_t                 xParamADCref[2];
  uint8_t                 xParamPitchMin[2];
  uint8_t                 xParamPitchMid[2];
  uint8_t                 xParamPitchMax[2];
  uint8_t                 xParamThroMin[2];
  uint8_t                 xParamThroMax[2];
